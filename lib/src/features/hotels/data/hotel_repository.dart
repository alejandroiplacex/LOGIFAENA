...
class InMemoryHotelRepository implements HotelRepository {
  ...
  final List<HotelAssignment> _assignments = [
    HotelAssignment(
      ...
      city: 'Calama',
      address: 'Av. Granaderos 1200',
      contactName: 'Marcela Soto',
      contactPhone: '+56 9 5555 1000',
      room: '302',
      checkInDate: DateTime(2026, 7, 20),
      checkOutDate: DateTime(2026, 7, 30),
      dailyRate: 62000,
      confirmationCode: 'HC-9081',
    ...
    HotelAssignment(
      id: 'h2',
      workerId: '3',
      hotelName: 'Hotel Norte',
      city: 'Antofagasta',
      address: 'Av. Brasil 850',
      contactName: 'Luis Mena',
      contactPhone: '+56 9 5555 2000',
      room: '115',
      checkInDate: DateTime(2026, 7, 18),
      checkOutDate: DateTime(2026, 7, 25),
      dailyRate: 58000,
      confirmationCode: 'HN-4412',
      notes: 'Traslado desde aeropuerto pendiente.',
      status: HotelStatus.checkedIn,
    ),
  ];
